package §521423133282313341123423632234§
{
   ...
   public class §class catch return§ implements §521423167552316768123423632234§
   {
      
      private var §dynamic finally static§:§521423167552316768123423632234§;
      
      public function §class catch return§(param1:§dynamic finally package§)
      {
         super();
         this.§dynamic finally static§ = param1.§5214238550238563123423632234§("521423133282313341123423632234.521423181072318120123423632234");
      }
      ...
      public function §5214239183239196123423632234§(param1:ByteArray) : Object
      {
         ...
         var _loc2_:Vector.<§get set try§> = new Vector.<§get set try§>(_loc3_,true);
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_[_loc4_] = §get set try§(this.§dynamic finally static§.§5214239183239196123423632234§(param1));
            _loc4_++;
         }
         return _loc2_;
      }
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:Vector.<§get set try§> = param2 as Vector.<§get set try§>;
