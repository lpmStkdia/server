package §521423140752314088123423632234§
{
   ...
   public class §set switch implements§ extends §package for class§
   {
      ...
      public function §set switch implements§(param1:String = "", param2:String = "")
      {
         super();
      ...
      {
         return new §set switch implements§();
      }
