package §5214233484233497123423632234§
{
   ...
   public class §5214239133239146123423632234§ extends §package for class§
   {
      
      public var §extends function false§:String;
      
      public function §5214239133239146123423632234§(param1:String = "")
      {
         super();
         this.§extends function false§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§extends function false§ = param1 as String;
         }
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §5214239133239146123423632234§();
      }
