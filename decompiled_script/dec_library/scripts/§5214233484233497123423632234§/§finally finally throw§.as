package §5214233484233497123423632234§
{
   ...
   public class §finally finally throw§ extends §package for class§
   {
      
      public var §5214236321236334123423632234§:String;
      
      public function §finally finally throw§(param1:String = "")
      {
         super();
         this.§5214236321236334123423632234§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§5214236321236334123423632234§ = param1 as String;
         }
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §finally finally throw§();
      }
