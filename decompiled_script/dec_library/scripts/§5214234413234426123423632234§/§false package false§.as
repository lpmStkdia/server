package §5214234413234426123423632234§
{
   ...
   public class §false package false§ implements §with const break§
   {
      
      private static const §throw catch static§:Number = 0.02;
      ...
      public function §false package false§(param1:§while package extends§, param2:IEventDispatcher, param3:§521423140292314042123423632234§, param4:Object3D)
      {
         super();
         this.§false set final§ = param1;
         this.§521423168882316901123423632234§ = param2;
         this.§5214234341234354123423632234§ = param3;
         this.§for catch native§ = param4;
      }
      ...
      public function §function const package§() : void
      {
         ...
         this.§for catch native§.rotationZ += this.§5214234341234354123423632234§.§5214234762234775123423632234§ * _loc2_;
         if(Math.abs(this.§5214234341234354123423632234§.§5214234762234775123423632234§) > 0.02)
         {
            this.§5214234341234354123423632234§.§5214234762234775123423632234§ *= Math.exp(-1.5 * _loc2_);
         }
         else
         {
            this.§5214234341234354123423632234§.§5214234762234775123423632234§ = 0;
            this.§false set final§.§521423131642313177123423632234§(this,§false const throw§.§switch const§);
         }
      }
   }
}
