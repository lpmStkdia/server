package §5214238913238926123423632234§
{
   ...
   public class §each var in§ extends §package for class§
   {
      ...
      public function §each var in§(param1:String = "", param2:§class set implements§ = null)
      {
         super();
