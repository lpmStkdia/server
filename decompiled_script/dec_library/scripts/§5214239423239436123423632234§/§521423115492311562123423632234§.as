package §5214239423239436123423632234§
{
   ...
   public class §521423115492311562123423632234§ extends §package for class§
   {
      
      public var §override finally false§:String;
      
      public function §521423115492311562123423632234§(param1:String = "")
      {
         super();
         this.§override finally false§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§override finally false§ = param1 as String;
         }
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §521423115492311562123423632234§();
      }
