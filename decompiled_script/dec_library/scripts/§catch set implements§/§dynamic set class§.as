package §catch set implements§
{
   ...
   public class §dynamic set class§ implements §each set while§
   {
      ...
      public function §dynamic set class§(param1:§5214231885231898123423632234§, param2:Vector.<Object>)
      {
         super();
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:§each set while§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc2_ = this.§521423141772314190123423632234§[_loc1_] as §each set while§;
               _loc2_.§default set static§();
               _loc1_++;
            }
         }
         finally
