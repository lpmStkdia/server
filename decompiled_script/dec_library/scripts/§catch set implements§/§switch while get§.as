package §catch set implements§
{
   ...
   public class §switch while get§ implements §521423109732310986123423632234§
   {
      ...
      public function §switch while get§(param1:§5214231885231898123423632234§, param2:Vector.<Object>)
      {
         super();
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:§521423109732310986123423632234§ = null;
         try
         {
            var _temp_1:* = Model;
            ...
            {
               _loc2_ = this.§521423141772314190123423632234§[_loc1_] as §521423109732310986123423632234§;
               _loc2_.§else for case§();
               _loc1_++;
            }
         }
         finally
