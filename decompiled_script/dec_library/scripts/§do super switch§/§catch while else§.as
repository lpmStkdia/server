package §do super switch§
{
   ...
   public class §catch while else§ extends §package for class§
   {
      
      public var §5214239149239162123423632234§:String;
      
      public function §catch while else§(param1:String = "")
      {
         super();
         this.§5214239149239162123423632234§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§5214239149239162123423632234§ = param1 as String;
         }
      }
