package §else use in§
{
   ...
   public class §5214232802232815123423632234§ extends §package for class§
   {
      
      public var §for switch each§:String;
      
      public function §5214232802232815123423632234§(param1:String = "")
      {
         super();
         this.§for switch each§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§for switch each§ = param1 as String;
         }
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §5214232802232815123423632234§();
      }
