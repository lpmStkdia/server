package §function const break§
{
   ...
   public class §with use with§ extends §package for class§
   {
      ...
      public function §with use with§(param1:int = 0, param2:String = "")
      {
         super();
         this.§5214231249231262123423632234§ = param1;
         this.§class finally finally§ = param2;
