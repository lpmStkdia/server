package §if finally each§
{
   ...
   public class §var switch case§ extends §package for class§
   {
      
      public var §get use default§:String;
      
      public var §5214236830236843123423632234§:Number;
      
      public function §var switch case§(param1:String = "", param2:Number = 0)
      {
         super();
         this.§get use default§ = param1;
         this.§5214236830236843123423632234§ = param2;
         ...
         §5214233209233222123423632234§("52142371523728123423632234.521423128082312821123423632234");
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §var switch case§();
      }
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         switch(param2)
         {
            case 0:
               ...
               break;
            case 1:
               this.§5214236830236843123423632234§ = param1 as Number;
         }
      }
   }
}
