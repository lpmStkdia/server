package §package catch each§
{
   ...
   public class §521423161472316160123423632234§ extends §package for class§
   {
      
      public function §521423161472316160123423632234§()
      {
         super();
      }
      ...
      {
         return new §521423161472316160123423632234§();
      }
