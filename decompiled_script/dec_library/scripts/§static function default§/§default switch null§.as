package §static function default§
{
   ...
   public class §default switch null§ extends §package for class§
   {
      
      public var §class use null§:String;
      
      public function §default switch null§(param1:String = "")
      {
         super();
         this.§class use null§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§class use null§ = param1 as String;
         }
      }
      ...
      {
         return new §default switch null§();
      }
   }
}
