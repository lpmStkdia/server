package §throw package try§
{
   import §521423193672319380123423632234§.§package for class§;
   
   public class §with switch super§ extends §package for class§
   {
      
      public var §5214232691232704123423632234§:String;
      
      public function §with switch super§(param1:String = "")
      {
         super();
         this.§5214232691232704123423632234§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§5214232691232704123423632234§ = param1 as String;
         }
      }
