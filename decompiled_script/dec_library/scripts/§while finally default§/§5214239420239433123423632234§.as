package §while finally default§
{
   ...
   internal class §5214239420239433123423632234§ extends Mesh
   {
      ...
      public function §5214239420239433123423632234§()
      {
         super();
         this.§default finally get§ = this.§var switch set§(-1,0,0,0,0.5);
         this.§do var catch§ = this.§var switch set§(1,0,0,1,0.5);
         this.§native var else§ = this.§var switch set§(1,1,0,1,1);
         this.§const function override§ = this.§var switch set§(-1,1,0,0,1);
      ...
      {
         return this.§const function override§.y;
      }
      ...
      public function §5214239350239363123423632234§(param1:Number, param2:Number, param3:Number, param4:Material) : void
      {
         ...
         boundMinY = this.§native var else§.y = this.§const function override§.y = param2;
         boundMaxY = 0;
      ...
      public function set §521423135952313608123423632234§(param1:Number) : void
      {
         ...
         boundMaxY = this.§native var else§.y = this.§const function override§.y = param1;
      }
   }
}
