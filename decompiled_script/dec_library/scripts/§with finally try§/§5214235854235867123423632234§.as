package §with finally try§
{
   ...
   public class §5214235854235867123423632234§ extends §package for class§
   {
      
      public var §get super var§:String;
      
      public function §5214235854235867123423632234§(param1:String = "")
      {
         super();
         this.§get super var§ = param1;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§get super var§ = param1 as String;
         }
      }
      
      override public function §5214234392234405123423632234§() : §package for class§
      {
         return new §5214235854235867123423632234§();
      }
