package §with finally try§
{
   import §521423193672319380123423632234§.§package for class§;
   
   public class §5214236148236161123423632234§ extends §package for class§
   {
      
      public var §default function with§:String;
      
      public var §do finally continue§:String;
      
      public function §5214236148236161123423632234§(param1:String = "", param2:String = "")
      {
         super();
         this.§default function with§ = param1;
         this.§do finally continue§ = param2;
      ...
      override public function §521423180452318058123423632234§(param1:Object, param2:int) : void
      {
         ...
         {
            case 0:
               this.§default function with§ = param1 as String;
               break;
            case 1:
               this.§do finally continue§ = param1 as String;
         }
      }
      ...
      {
         return new §5214236148236161123423632234§();
      }
   }
}
